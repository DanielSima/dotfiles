...
c_FAN_TACHO	= 17			# gpio pin the fan tachometer is connected to
c_MIN_TEMPERATURE = 63		# temperature in degrees c when fan should turn on
...
def getHDDTemp():
	...
	return int(res)	#return int(30)	# cast result to int
